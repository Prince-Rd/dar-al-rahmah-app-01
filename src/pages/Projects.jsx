        ...
        <div>
          ...
          <div className="  md:flex justify-between relative pt-32">
            ...
            <div className="md:w-[30%] mt-4 relative">
              ...
              <h1 className="absolute md:top-1/2 md:left-1/2 text-nowrap mx-2 md:transform md:-translate-x-1/4 md:-translate-y-1/2 text-lg md:text-4xl font-bold text-tertiary mb-6">
                محفظة الأعمال
              </h1>
            </div>
